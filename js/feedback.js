...
function applyLanguage() {
  ...
  /* NAV */
  /* HEADER */
  document.getElementById("headerTitle").textContent = language.feedback.headerTitle;
  /* HEADER */
  /* FOOTER */
  ...
  /* FEEDBACK FORM */
  document.getElementById("feedbackTopText").textContent = language.feedback.feedbackTopText;
