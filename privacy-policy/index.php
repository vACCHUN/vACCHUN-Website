...
<body>
    ...
    <header>
        <div id="header-center" class="header-center">
            <h1 id="headerTitle">Adatvédelem</h1>
        </div>
    ...
    <section class="pp">
        <div class="content">
            <div id="dearVisitor">
                <h2 id="dearVisitor-title"></h2>
                <p id="dearVisitor-txt"></p>
            </div>
            <div id="autoInfo">
                <h2 id="autoInfo-title"></h2>
                <p id="autoInfo-txt"></p>
            </div>
            <div id="contact">
            ...
            <div id="cookies">
                <h2 id="cookies-title"></h2>
                <p id="cookies-txt"></p>
            </div>
            <div id="others">
                <h2 id="others-title"></h2>
                <p id="others-txt"></p>
            </div>
            <div id="rights">
                <h2 id="rights-title"></h2>
                <p id="rights-txt"></p>
            </div>
            <div id="official">
                <h2 id="official-title"></h2>
                <p id="official-txt"></p>
            </div>
        </div>
    </section>
